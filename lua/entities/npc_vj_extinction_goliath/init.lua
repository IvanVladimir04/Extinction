...
ENT.ItemDropsOnDeath_EntityList = {"weapon_vj_m16a1"} -- List of items it will randomly pick from | Leave it empty to drop nothing or to make your own dropping code (Using CustomOn...)
...
function ENT:CustomOnInitialize()
	...
	self:SetColor(Color(121, 16, 16, 255))
end
--------------------------------------------------------------------------------------------------------------------------------------------
