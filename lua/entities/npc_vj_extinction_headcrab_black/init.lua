...
ENT.AnimTbl_LeapAttack = {"Flinch1"} -- Melee Attack Animations
...
ENT.LeapAttackVelocityForward = 105 -- How much forward force should it apply?
ENT.LeapAttackVelocityUp = 255 -- How much upward force should it apply?
...
function ENT:CustomOnAlert()
	self:VJ_ACT_PLAYACTIVITY("Threatdisplay",true,1.7,true)
	self.SoundTbl_Alert = {"headcrab_poison/ph_scream1.wav","headcrab_poison/ph_scream2.wav","headcrab_poison/ph_scream3.wav"}
end
/*-----------------------------------------------
